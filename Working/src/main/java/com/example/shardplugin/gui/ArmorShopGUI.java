...
public class ArmorShopGUI {
    ...
    public void handleClick(final InventoryClickEvent event) {
        ...
        if (armorInfo != null) {
            ...
            if (isVoidCost) {
                ...
                if (!this.plugin.getShardManager().removeVoidShards(player, cost)) {
    ...
    private void handleEnchantedShardConversion() {
        ...
        if (meta != null) {
            meta.setDisplayName(currencyConfig.getString("name", "§d✨ Enchanted Shard"));
            meta.setCustomModelData(currencyConfig.getInt("custom_model_data", 1002));
            meta.setLore(currencyConfig.getStringList("lore"));
    ...
    private void handleVoidShardConversion() {
        ...
        final int conversionRate = currencyConfig.getInt("conversion_rate", 5);
        ...
        if (meta != null) {
            meta.setDisplayName(currencyConfig.getString("name", "§5✧ Void Shard"));
            meta.setCustomModelData(currencyConfig.getInt("custom_model_data", 1003));
            meta.setLore(currencyConfig.getStringList("lore"));
    ...
    private void handleEnchantedPickaxeShardConversion() {
        ...
        final int conversionRate = currencyConfig.getInt("conversion_rate", 8);
        ...
        if (meta != null) {
            meta.setDisplayName(currencyConfig.getString("name", "§d⛏ Enchanted Pickaxe Shard"));
            meta.setCustomModelData(currencyConfig.getInt("custom_model_data", 1005));
            meta.setLore(currencyConfig.getStringList("lore"));
